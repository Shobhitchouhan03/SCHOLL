...
JWT_ACCESS_SECRET=(Auto-generated by Render or 64-char random string)
JWT_REFRESH_SECRET=(Auto-generated by Render or 64-char random string)
...
> [!NOTE]
> `PORT` is dynamically injected by Render (`process.env.PORT`). Do not hardcode `PORT=5000` in production blueprints.
