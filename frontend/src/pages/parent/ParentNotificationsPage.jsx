    ...
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full space-y-6">
          <div className="bg-white rounded-3xl p-6 border border-almond/40 shadow-card flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-textMuted mt-0.5">
                Read-only notification inbox for school announcements, fee reminders, homework, and attendance alerts.
              </p>
            </div>
